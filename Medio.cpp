...
void Medio::updateEnemiesRAndCombat() {
...
void Medio::updateEnemiesAndCombat() {
    //Aparicion de enemigos
    if (this->canSpawn){
        if (this->cant_enemigos != 0){
...
void Medio::initBulletCollectorGUI() {
    if (!this->font.loadFromFile("/home/fernandez/datos2/Proyecto1_BattleSpace/fonts/ChakraPetch-Regular.ttf"))
        std::cout << "ERROR::GAME::Failed to load font" << endl;
...
void Medio::initBackground() {
    if (!this->backgroundTex.loadFromFile("/home/fernandez/datos2/Proyecto1_BattleSpace/Textures/evening_sky.jpg")){
...
void Medio::renderBackground() {
    this->window->draw(this->background);
}

void Medio::updateBackground() {

}

void Medio::updateCollision() {
